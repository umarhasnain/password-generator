  ...
  return (
    <footer className="bg-blue-500 text-white py-8 px-4">
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center text-center md:text-left">
        ...
        <div className="mb-6 md:mb-0">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-2xl font-bold">RandomPasswordGeneratorFree</span>
          </div>
        </div>
      ...
      <div className="mt-6 text-center md:text-left flex flex-col md:flex-row justify-between items-center container mx-auto">
        ...
        <p className="text-sm mt-4 md:mt-0">© 2025 RandomPasswordGeneratorFree. All rights reserved.</p>
      </div>
    </footer>
  );
};

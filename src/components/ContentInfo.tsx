...
const sections = [
  {
    title: <>FreeStrongPasswordGenerator&ndash; Secure Passwords Made Simple</>,
    content: (
      <>
        <Link href="/#" className="text-blue-600 underline hover:text-blue-800">
          FreeStrongPasswordGenerator
        </Link>{" "}
        provides a free and secure solution to generate passwords to keep your
        data safe. Whether protecting a personal email, some financial accounts,
        or work logins, this tool can help you through. It helps you to secure
        accounts at no cost.
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        Password strength begins with the element of guessability. If nobody can
        guess it, it is a good password. That is why our{" "}
        <Link href="/#" className="text-blue-600 underline hover:text-blue-800">
          random password generator
        </Link>{" "}
        functions unpredictably every time it is used. The password generated
        will contain unpredictable strings rather than familiar words or dates;
        for example, something like &quot;P7$kL!v9mQ2j&quot;. This type of password is
        impossible to crack.
      </>
    ),
  },
  ...
  },
  {
    ...
    content:
      "For the highest level of security, FreeStrongPasswordGenerator.com&rsquo;s 16-character password generator is unmatched. These passwords are for critical applications like financial accounts or primary email addresses. The sheer number of possible combinations makes them nearly impossible to crack, with cracking times extending beyond the age of the universe using today&rsquo;s technology. This tool ensures true randomness, likely using algorithms akin to industry leaders, and generates passwords on your device for maximum privacy. Choose this option for big protection against even the most determined cybercriminals.",
  },
  {
  ...
  {
    title: <>Best Password Generator: Why We&rsquo;re Your Top Choice</>,
    content: (
      <>
        What makes FreeStrongPasswordGenerator.com truly the finest password
        generator out there? Well, it is our dedication towards the cause of
        quality and variability. We go the entire nine yards in terms of a
        password generator 12 characters all the way through a password
        generator 15 characters, ensuring that you get exactly what you&apos;re
        after. Our easy to remember password generator generator creates
        passwords such as &quot;Tree$Leaf88&quot; for a while and then hits you with a{" "}
        <Link href="/#" className="text-blue-600 underline hover:text-blue-800">
          strong password generator
        </Link>{" "}
        random that truly leaves you with a string of
        numbers and letters that even you cannot guess. Providing a fast,
        secure, and free password generator online comes handy for either a
        beginner or an advanced computer user. With
        FreeStrongPasswordGenerator.com, you are truly your own master.
        Customize your passwords according to what you need, and rest easy
  ...
  },
  {
    ...
    content:
      "Passwords are your first line of defense in the digital world, and we&apos;re here to help you make them as strong as possible. FreeStrongPasswordGenerator.com provides the best password...",
  },
];
  ...
  return (
    <div className="overflow-x-hidden">
      <main className="bg-gradient-to-br from-slate-50 to-slate-100 text-white py-10 px-2 sm:px-4 md:px-6 lg:px-8 max-w-7xl mx-auto space-y-10">
        ...
        >
         Free Random Password Generator Create Strong Passwords in Seconds
        </motion.h1>
